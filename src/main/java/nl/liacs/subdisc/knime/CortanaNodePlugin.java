 ...
 * @author Marvin Meeng
 */
public class CortanaNodePlugin extends Plugin {
    // The shared instance.
    private static CortanaNodePlugin plugin;

    /**
     * The constructor.
     */
    public CortanaNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CortanaNodePlugin getDefault() {
        return plugin;
    }
