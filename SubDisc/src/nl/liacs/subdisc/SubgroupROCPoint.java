 ...
 * <code>Point2D&nbsp;.x</code> and
 * {@link Subgroup#getTruePositiveRate() getTruePositiveRate()} for
 * <code>Point2D&nbsp;.y</code>.
...
public class SubgroupROCPoint extends Point2D.Float
{
	...
	/**
	 * Creates a SubgroupROCPoint for the {@link Subgroup Subgroup} passed in as
	 * parameter.
	 * @param theSubgroup the Subgroup for which to create the SubgroupROCPoint.
	 */
	...
	/**
	 * Overrides <code>Object</code>s' <code>toString()</code> method to to get
