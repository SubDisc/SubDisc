...
//		jButtonDataModel = new JButton();
		...
		jMenuItemDataExplorer.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent evt) { DataExplorerActionPerformed(evt);	}
			}
		);
		...
		jMenuItemBrowseTarget.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent evt) { BrowseActionPerformed(evt); }
			}
		);
		...
		jMenuItemSubgroupDiscovery.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent evt) { jButtonSubgroupDiscoveryActionPerformed(evt); }
			}
		);
	...
	//dataset =================================
		...
		jPanelRuleTarget.setBorder(new TitledBorder(
			new EtchedBorder(), "dataset", 4, 2, new Font ("Dialog", 1, 11)));
	...
	// target concept ======================================================================
		...
		jPanelRuleEvaluation.setBorder(new TitledBorder(
			new EtchedBorder(), "target concept", 4, 2,
		...
		jComboBoxTargetType.addActionListener(new ActionListener()
			{
			public void actionPerformed(ActionEvent evt) { jComboBoxTargetTypeActionPerformed(evt);}
			}
		);
		...
		jComboBoxQualityMeasure.addActionListener(new ActionListener()
			{
			public void actionPerformed(ActionEvent evt) { jComboBoxQualityMeasureActionPerformed(evt);}
			}
		);
	...
	//search conditions ===================================================================
		...
		jPanelSearchParameters.setBorder(new TitledBorder(
			new EtchedBorder(), "search conditions", 4, 2,
			new Font ("Dialog", 1, 11)));
		...
		jPanelSearchStrategy.setBorder(new TitledBorder(
			new EtchedBorder(), "search strategy", 4, 2,
			new Font ("Dialog", 1, 11)));
...
//		}
	...
	private	void initTargetType()
	{
		...
		System.out.println("jComboBoxTargetType.getItemCount() = " + jComboBoxTargetType.getItemCount());	// MM TODO should be 0, removeAllItems() does not work on unmutable items
